...
//  VICINTENABLE |= 1UL << VIC_EINT3;  // Original.
  VICINTENABLE_bit.EINT3 = 1;          // Modifired.
...
*/
  ...
  // Init delay timer
  PCONP_bit.PCTIM2 = 1; // Enable TIM0 clocks **PCTIM0
  T2TCR = 2;            // stop and reset timer 0 **T0TCR...T0IR
